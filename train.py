...
training_args.add_argument('--n_epochs', type=int, default=1000, help='Number of training epochs')
...
training_args.add_argument('--ns', type=int, default=0, help='Noise schedule')
...
run_name = f'n_dim={n_dim},n_steps={n_steps},lbeta={lbeta:.3e},ubeta={ubeta:.3e},batch_size={batch_size},n_epochs={n_epochs},noise_schedule={ns}'
